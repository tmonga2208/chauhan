...
export function ProductCard({ title, img, price, categories, id, className }: ProductProps) {
  return (
    <CardContainer className={`inter-var ${className}`}>
      <CardBody className="bg-black relative group/card   dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-white dark:border-white/[0.2] border-white/[0.1] w-auto sm:w-[20rem] h-[30rem] rounded-xl p-6 border  ">
        <CardItem
          translateZ="50"
